...
style_img = image_loader("./data/images/neural-style/picasso_selfportrait.jpg")
content_img = image_loader("./data/images/neural-style/japanese_garden.jpg")
...
# function, which reevaluates the modul and returns the loss.0
# 
